// CACHE_BUST_VERSION: 20260710133548
(function () {
  "use strict";
    ...
    if (status) {
      ...
      var label = state.dataSource === "local"
        ...
        : state.dataSource === "fallback"
          ? (isFileMode ? "当前使用：内置备用数据。file:/// 直接预览不能可靠读取 JSON，请用 Live Server / GitHub Pages / 导入 JSON。" : "当前使用：内置备用数据。正式 JSON 未读取成功，已禁止导出 fallback。")
